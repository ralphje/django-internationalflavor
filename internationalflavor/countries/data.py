...
COUNTRY_NAMES = {
    "AC": _("Ascension Island"),  # exceptional reservation
    "AD": _("Andorra"),
    ...
    "AL": _("Albania"),
    "AM": _("Armenia"),
    "AN": _("Netherlands Antilles"),  # transitional reservation
    "AO": _("Angola"),
    "AQ": _("Antarctica"),
    "AR": _("Argentina"),
    "AS": _("American Samoa"),
    ...
    "CN": _("China"),
    "CO": _("Colombia"),
    "CP": _("Clipperton Island"),  # exceptional reservation
    "CR": _("Costa Rica"),
    "CU": _("Cuba"),
    "CV": _("Cape Verde"),
    "CW": _("Curaçao"),
    ...
    "CZ": _("Czech Republic"),
    "DE": _("Germany"),
    "DG": _("Diego Garcia"),  # exceptional reservation
    "DJ": _("Djibouti"),
    "DK": _("Denmark"),
    "DM": _("Dominica"),
    "DO": _("Dominican Republic"),
    "DZ": _("Algeria"),
    "EA": _("Ceuta and Melilla"),  # exceptional reservation
    "EC": _("Ecuador"),
    "EE": _("Estonia"),
    "EG": _("Egypt"),
    "EH": _("Western Sahara"),
    ...
    "ES": _("Spain"),
    "ET": _("Ethiopia"),
    "EU": _("European Union"),  # exceptional reservation
    "FI": _("Finland"),
    "FJ": _("Fiji"),
    ...
    "HT": _("Haiti"),
    "HU": _("Hungary"),
    "IC": _("Canary Islands"),  # exceptional reservation
    "ID": _("Indonesia"),
    "IE": _("Ireland"),
    "IL": _("Israel"),
    "IM": _("Isle of Man"),
    ...
    "PY": _("Paraguay"),
    "QA": _("Qatar"),
    "QO": _("Outlying Oceania"),  # used by CLDR
    "RE": _("Réunion"),
    "RO": _("Romania"),
    "RS": _("Serbia"),
    "RU": _("Russia"),
    ...
    "SY": _("Syria"),
    "SZ": _("Swaziland"),
    "TA": _("Tristan da Cunha"),  # exceptional reservation
...
"""All country names based on the CLDR."""
